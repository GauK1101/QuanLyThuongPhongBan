...
public partial class TbThuongDaiDoanDuAn : BaseViewModel
{
    ...
    public decimal? GiaTriTongGoi
    {
        get => Get<decimal?>();
        set => Set(value);
    }

    public decimal? GiaTriDieuChinhDot1
    {
        get => Get<decimal?>();
        set => Set(value);
    }

    public decimal? TiLeDieuChinhDot1
    {
        get => Get<decimal?>();
        set => Set(value);
    }

    public decimal? GiaTriDieuChinhDot2
    {
        get => Get<decimal?>();
        set => Set(value);
    }

    public decimal? TiLeDieuChinhDot2
    {
        get => Get<decimal?>();
        set => Set(value);
    }
